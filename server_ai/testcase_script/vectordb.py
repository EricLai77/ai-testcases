...
class VectorDatabase:
    ...
    def create(self, id, vector_id, text):
        ...
        with self.connection.cursor() as cursor:
            sql = "INSERT INTO vectors (id, vector_id, text) VALUES (%s, %s, %s)"
    ...
    def create_needs_text(self, text, needs): 
        self.connect()
        with self.connection.cursor() as cursor:
            sql = "INSERT INTO requirements (text, needs) VALUES (%s, %s)"
    ...
    def create_needs_manage_text(self, vector_id, needs_id, needs_info):
        self.connect()
        with self.connection.cursor() as cursor:
            sql = "INSERT INTO needs_manage (vector_id , needs_id , needs_info) VALUES (%s, %s, %s)"
            cursor.execute(sql, (vector_id, needs_id, needs_info))
        self.connection.commit()
        self.close()
